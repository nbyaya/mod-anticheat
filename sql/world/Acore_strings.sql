...
(30087, '|cffffff00[|cffff0000ANTICHEAT ALERT|r|cffffff00]:|r |cFFFF8C00|r |cFFFF8C00[|Hplayer:%s|h%s|h|r|cFFFF8C00]: POSSIBLE HACK, CHECK ME NOW!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
